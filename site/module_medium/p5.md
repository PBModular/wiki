...
Providing clear help information is essential for users. PBModular offers two ways for modules to define their help content, which is typically displayed by a core command like `/help YourModuleName`.
